    ...
    <>
          ...
          <Card className='about-card  mt-lg-3 rounded-4 border-0 shadow-lg bg-primary-subtle'>
            <Card.Body>
              <Card.Text className='fs-5'>
                ...
                na warszawskim AWF i już jako student pilotowałem wycieczki. Rok pracowałem w Almaturze Warszawa, gdzie nauczyłem się
                organizacji wycieczek. Po kilku latach pracy pod obcym szyldem założyłem swoje biuro, które fajnie się rozwijało do
                pandemii…tysiące zadowolonych klientów, życie w rozjazdach, było dobrze…Przyszła zaraza i legendarna pomoc panstwa
                ale…. Po 4 latach wracam do zawodowej pasji! Proszę zaufać mi ponownie…ćwierć wieku doświadczenia o czymś świadczy.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
      ...
      <Row className='mb-4 '>
        ...
        <Col xs={12} md={8} lg={7}>
          <Card className='about-card ms-lg-n5 mt-lg-3 rounded-4 border-0 shadow-lg bg-primary-subtle'>
            <Card.Body>
              <Card.Text className='fs-5'>
                <span className='fw-bold'>BIURO PODROZY TOURGUIDE</span> istnieje od 2008 z 4 letnia przerwa w latach pandemicznych.
                Działalność firmy ubezpiecza Compensa/ Viener z siedzibą w Warszawie ul. Aleje Jerozolimskie 162. Terytorium
                działalności to Polska i kraje sąsiednie. Właścicielem biura jestem ja - Tomasz Zdunek.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
      ...
      <Row className='mb-4'>
        <Col className='order-1 order-md-0' xs={12} md={8}>
          <Card className='about-card me-lg-n5 mt-lg-3 rounded-4 border-0 shadow-lg bg-primary-subtle'>
            <Card.Body>
              <Card.Text className='fs-5'>
                Firma specjalizuje się w organizacji turystyki autokarowej dla grup dzieci, młodzieży, pracowników szkół i firm,
                seniorów. Z nami zorganizujesz krótki spacer po mieście ale też dwutygodniowe kolonie/ obozy czy trampingi rowerowe.
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
          ...
          <Card className='about-card mt-lg-3 rounded-4 border-0 shadow-lg bg-primary-subtle'>
            <Card.Body>
              <ul className='about-details fs-5 list-unstyled'>
                ...
                <li>
                  <i className='bi bi-arrow-right-circle-fill me-2'></i>preferujemy aktywność fizyczną podczas wyjazdów ale to klient
                  decyduje co będzie robił
                </li>
                <li>
                ...
                <li>
                  <i className='bi bi-arrow-right-circle-fill me-2'></i>ceny zawarte na WWW i folderze są skalkulowane dla wyjazdów z
                  Warszawy…
                </li>
                <li>
                  <i className='bi bi-arrow-right-circle-fill me-2'></i>Jeśli mieszkasz gdzie indziej, napisz do nas a wycenimy Twoją
                  podróż najszybciej jak się da
                </li>
              </ul>
            </Card.Body>
          </Card>
